...
**Version:** see [`VERSION`](./VERSION) — currently `0.8.1`
...
A spec tag (`v0.8.1`) corresponds 1:1 to a release tag in every SDK
...
Examples: `dmzagent-python/0.8.1`, `dmzagent-typescript/0.8.1`,
`dmzagent-csharp/0.8.1`, `dmzagent-java/0.8.1`. Optional suffix in the
...
"the surface is verified", and at 0.8.1 that is not what it means.
